...
export default function CompartilharCurtei({chats,idCurtei, curtei, visibilidade, onClose}) {
...
const selecionarCompartilhamento = (item, tipo) => {
 ...
 const enviarPost = async () => {
  ...
  try {
    ...
    Alert.alert('Sucesso', 'Curtei enviado com sucesso!');

  } catch (error) {
    setCarregamento(false);
    console.error("Erro ao enviar mensagens:", error);
    Alert.alert('Erro', 'Falha ao enviar o Curtei');
  }
};
